...
#define AI_NETWORK_MODEL_SIGNATURE     "658b5641b8fc684bb690863d51f577e6"
...
#define AI_TOOLS_DATE_TIME   "Tue May 13 16:21:08 2025"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 163, 1), AI_STRIDE_INIT(4, 4, 4, 256, 41728),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 81, 1), AI_STRIDE_INIT(4, 4, 4, 256, 20736),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 1, 5184, 1, 1), AI_STRIDE_INIT(4, 4, 4, 20736, 20736),
  1, &pool_10_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 5184, 32, 1, 1), AI_STRIDE_INIT(4, 4, 20736, 663552, 663552),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  16, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 333, 1), AI_STRIDE_INIT(4, 4, 4, 4, 1332),
  1, &serving_default_keras_tensor0_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  17, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 331, 1), AI_STRIDE_INIT(4, 4, 4, 128, 42368),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  19, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 165, 1), AI_STRIDE_INIT(4, 4, 4, 128, 21120),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 689420, 1, 1),
    689420, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 62848, 1, 1),
    62848, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 42368);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 42368);
    ...
    conv2d_7_output_array.data = AI_PTR(g_network_activations_map[0] + 21120);
    conv2d_7_output_array.data_start = AI_PTR(g_network_activations_map[0] + 21120);
    
    nl_7_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 21120);
    nl_7_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 21120);
    ...
    gemm_12_output_array.data = AI_PTR(g_network_activations_map[0] + 20736);
    gemm_12_output_array.data_start = AI_PTR(g_network_activations_map[0] + 20736);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_7_weights_array.data = AI_PTR(g_network_weights_map[0] + 512);
    conv2d_7_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 512);
    
    conv2d_7_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_bias_array.data = AI_PTR(g_network_weights_map[0] + 25088);
    conv2d_7_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 25088);
    
    gemm_12_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_12_weights_array.data = AI_PTR(g_network_weights_map[0] + 25344);
    gemm_12_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 25344);
    
    gemm_12_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_12_bias_array.data = AI_PTR(g_network_weights_map[0] + 688896);
    gemm_12_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 688896);
    
    gemm_13_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_13_weights_array.data = AI_PTR(g_network_weights_map[0] + 689024);
    gemm_13_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 689024);
    
    gemm_13_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_13_bias_array.data = AI_PTR(g_network_weights_map[0] + 689408);
    gemm_13_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 689408);
